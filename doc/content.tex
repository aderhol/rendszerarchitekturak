...
\begin{lstlisting}[frame=single,language=verilog,caption={Receive modul},captionpos=b,label={lst:apb}]
module receiver(
    input clk,
    input rst,
...
\begin{lstlisting}[frame=single,language=verilog,caption={Transmit modul},captionpos=b,label={lst:apb}]
module transmitter(
    input clk,
    input rst,
    input [15:0] N, //f_sampling = F_osc / N = 16 * baud
